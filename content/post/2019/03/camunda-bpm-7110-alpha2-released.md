...
This is the first alpha release on the road to **Camunda BPM 7.11** (due May 30, 2019). Stay tuned for more features around permissions, job execution and testing support. For details see our [roadmap](https://camunda.com/learn/community/#roadmap).
